...
- Figure 5: TODO Jon.
- Figure 6: binary classification test AUC. [[file:figure-unbalanced-grad-desc.R][R code]].
- Figure 7: speed comparison. TODO binary, [[file:figure-aum-grad-speed.R][R code for changepoint]].
