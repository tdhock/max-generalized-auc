...
- Figure 7: speed comparison. [[file:figure-aum-grad-speed-binary-cpp-algos.png][Left PNG]], [[file:figure-aum-grad-speed-binary-cpp.R][R code for binary
  classification]]; [[file:figure-aum-grad-speed.png][Right PNG]], [[file:figure-aum-grad-speed.R][R code for changepoint detection]].
...
[[file:figure-aum-grad-speed-binary.R]] updated to make
