...
Title: [[https://github.com/tdhock/max-generalized-auc/blob/master/HOCKING-slides-toronto.pdf][Efficient line search for optimizing Area Under the ROC Curve
in gradient descent]]
