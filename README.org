...
- How does the best linear model compare to the best test AUM after
  running gradient descent on just the predicted values? (without
  linear model)
