...
\begin{frame}
  ...
  \includegraphics[width=\textwidth]{figure-aum-convexity-interactive-diff4-1}
\end{frame}
...
\begin{frame}
  ...
  \includegraphics[width=\textwidth]{figure-aum-convexity-interactive-diff4-2}
\end{frame}
...
\begin{frame}
  ...
  \includegraphics[width=\textwidth]{figure-aum-convexity-interactive-diff4-3}
\end{frame}
...
\begin{frame}
  ...
  \includegraphics[width=\textwidth]{figure-aum-convexity-interactive-diff4}
\end{frame}
